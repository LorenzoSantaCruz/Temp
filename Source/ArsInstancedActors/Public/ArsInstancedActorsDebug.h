...
#define WITH_ARSINSTANCEDACTORS_DEBUG (!(UE_BUILD_SHIPPING || UE_BUILD_SHIPPING_WITH_EDITOR || UE_BUILD_TEST) && WITH_MASSGAMEPLAY_DEBUG && 1)
...
namespace UE::ArsInstancedActors::Debug
{
	...
	void LogInstanceCountsOnScreen(const int32& DebugDrawMode, const AArsInstancedActorsManager& Manager, float TimeToDisplay = 4.0f, FColor Color = FColor::Magenta);
	void DebugDrawAllInstanceLocations(const int32& DebugDrawMode, ELogVerbosity::Type Verbosity, const AArsInstancedActorsManager& Manager, const TOptional<FColor> Color, const UObject* LogOwner, const FName& CategoryName = TEXT("LogArsInstancedActors"));
