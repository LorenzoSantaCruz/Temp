...
bool UInstancedActorsModifierVolumeComponent::TryRunPendingModifiers(AInstancedActorsManager& Manager, TBitArray<>& InOutPendingModifiers)
{
	...
	if (bIgnoreOwnLevelsInstances)
	{
		...
		{
			FTopLevelAssetPath ManagerLoadedPath = UE::InstancedActors::Helpers::FindLevelWorldPartitionAssetPath(ManagerLevel);
			FTopLevelAssetPath OwnerLoadedPath = UE::InstancedActors::Helpers::FindLevelWorldPartitionAssetPath(OwnerLevel);
