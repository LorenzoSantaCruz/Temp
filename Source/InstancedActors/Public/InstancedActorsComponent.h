...
public:
	...
	UE_API UInstancedActorsComponent();
	 ...
	 */
	UE_API virtual void OnServerPreSpawnInitForInstance(FInstancedActorsInstanceHandle InInstanceHandle);
	 ...
	 */
	UE_API virtual void InitializeComponentForInstance(FInstancedActorsInstanceHandle InInstanceHandle);
