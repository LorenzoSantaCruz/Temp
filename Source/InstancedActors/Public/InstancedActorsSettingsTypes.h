...
struct FInstancedActorsSettings : public FTableRowBase
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Meta = (EditCondition = "bOverride_bModifierVolumeCheckFullyEnclosed"), Category=InstancedActors)
	bool bModifierVolumeCheckFullyEnclosed = false;
	
	/** Gameplay Tags that can be used in Modifier queries */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Meta = (EditCondition = "bOverride_GameplayTags"), Category=InstancedActors)
