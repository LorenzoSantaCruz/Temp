...
*/
class ARSINSTANCEDACTORSEDITOR_API FArsInstancedActorsEditorModule : public IModuleInterface
{
public:
	...
	void CustomizedConvertActorsToIAsUIAction(TConstArrayView<AActor*> InActors, TSubclassOf<UArsInstancedActorsSubsystem> IASubsystemClass) const;
